...
func getEnglishMessages() map[string]string {
	return map[string]string{
		...
		"import_encrypted_backup_desc": "Restore a Bloco encrypted backup",
...
func getPortugueseMessages() map[string]string {
	return map[string]string{
		...
		"import_encrypted_backup_desc": "Restaurar backup criptografado Bloco",
...
func getSpanishMessages() map[string]string {
	return map[string]string{
		...
		"import_watch_only_desc":       "Seguir dirección sin secretos de firma",
		"import_batch_keystore":        "Importación por Lote",
		"import_batch_keystore_desc":   "Importar varios archivos KeystoreV3",
		"import_encrypted_backup":      "Copia Encriptada",
		"import_encrypted_backup_desc": "Restaurar copia encriptada Bloco",
