...
func AddWalletImportMessages() {
	...
	english := map[string]string{
		...
		"sensitive_data_hidden":            "Hidden - use the explicit export flow",
	...
	portuguese := map[string]string{
		...
		"sensitive_data_hidden":            "Oculto - use o fluxo explícito de exportação",
	...
	spanish := map[string]string{
		...
		"sensitive_data_hidden":            "Oculto - usa el flujo explícito de exportación",
